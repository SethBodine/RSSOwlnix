...
public class Messages extends NLS {
  ...
  public static String ApplicationActionBarAdvisor_BROWSER_TOOLBAR;
  public static String ApplicationActionBarAdvisor_CLASSIC_LAYOUT;
  public static String ApplicationActionBarAdvisor_COLUMNS;
  ...
  public static String ApplicationActionBarAdvisor_LIST_LAYOUT;
  ...
  public static String Controller_CANCEL_ACTIVE_DOWNLOADS;
  ...
  public static String Controller_EXIT_RSSOWL;
  ...
  public static String CoolBarAdvisor_ARCHIVE;
  public static String CoolBarAdvisor_ARCHIVE_NEWS;
  ...
  public static String OwlUI_LIST_LAYOUT;
